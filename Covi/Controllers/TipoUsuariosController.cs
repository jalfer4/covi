...
namespace Covi.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoUsuarioId,Nombre,EstaHabilitado,EstaPublicado")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoUsuarioId,Nombre,EstaHabilitado,EstaPublicado")] TipoUsuario tipoUsuario)
        {
